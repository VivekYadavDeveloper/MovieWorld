    ...
    return (
        <>
            ...
            <div className='navbar bg-sky-300 sm:hidden block '>
                <Link href={"/"} className='btn btn-ghost text-xl'>Movie World</Link>
            </div>
            ...
            <div className="navbar bg-base-100 shadow-sm">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            ...
                            <li><Link href={'/tv_show'}>Tv Show</Link></li>
                        </ul>
                    </div>
                    <Link href={'/'} className="btn btn-ghost text-xl sm:block hidden">Movies World</Link>
                </div>
                ...
                <div className="navbar-center rounded-4xl">
