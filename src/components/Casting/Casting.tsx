        ...
        {cast.length > 0 ? (
          cast
            ...
            .map((actor, index) => (
              ...
              >
                <Image
                  className="object-top object-fill w-full rounded-2xl"
                  src={`https://image.tmdb.org/t/p/w500${actor.profile_path}`}
                  alt={actor.name}
                  width={350}
                  height={700}
                />
                <div className="absolute inset-0 flex items-end justify-center bg-gradient-to-t from-black to-transparent p-2 rounded-2xl">
                  <div>
